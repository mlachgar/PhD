...
Le second moment est obtenu en substituant les expressions correspondantes de $\Pi(k_i)$ et $k_i(t)$ dans Eq.~\ref {eq8-2}, nous obtenons pour les temps très grands
 \begin{eqnarray}
\begin{split}
